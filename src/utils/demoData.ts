...
export async function populateDemoData() {
  ...
  await nutritionRepository.createMeal(
    ...
    [
      { name: 'Oatmeal', quantity: 1, unit: 'cup', calories: 150, protein: 5, carbs: 27, fat: 3, isAIGenerated: false },
      { name: 'Blueberries', quantity: 0.5, unit: 'cup', calories: 40, protein: 0, carbs: 10, fat: 0, isAIGenerated: false },
      { name: 'Banana', quantity: 1, unit: 'medium', calories: 105, protein: 1, carbs: 27, fat: 0, isAIGenerated: false },
      { name: 'Almond milk', quantity: 1, unit: 'cup', calories: 30, protein: 1, carbs: 1, fat: 2.5, isAIGenerated: false },
      { name: 'Honey', quantity: 1, unit: 'tbsp', calories: 25, protein: 0, carbs: 6, fat: 0, isAIGenerated: false },
    ]
  );
  ...
  await nutritionRepository.createMeal(
    ...
    [
      { name: 'Grilled chicken breast', quantity: 6, unit: 'oz', calories: 280, protein: 35, carbs: 0, fat: 6, isAIGenerated: false },
      { name: 'Mixed greens', quantity: 2, unit: 'cups', calories: 20, protein: 2, carbs: 4, fat: 0, isAIGenerated: false },
      { name: 'Cherry tomatoes', quantity: 0.5, unit: 'cup', calories: 15, protein: 1, carbs: 3, fat: 0, isAIGenerated: false },
      { name: 'Avocado', quantity: 0.5, unit: 'medium', calories: 120, protein: 1, carbs: 6, fat: 10, isAIGenerated: false },
      { name: 'Olive oil dressing', quantity: 2, unit: 'tbsp', calories: 85, protein: 0, carbs: 0, fat: 9, isAIGenerated: false },
    ]
  );
  ...
  const journalEntries = [
    {
      ...
      content: 'Had a great start to the week. Finished my morning workout early and felt energized all day. Made progress on the project at work and had a nice dinner with friends.',
      mood: 5 as const,
    },
    {
      date: format(subDays(new Date(), 1), 'yyyy-MM-dd'),
      title: 'Reflection',
      content: 'Took some time today to think about my goals for the month. I want to be more consistent with my habits and spend less time on my phone. Starting tomorrow, I\'ll track my screen time.',
      mood: 4 as const,
    },
    {
      date: today,
      title: 'New beginnings',
      content: 'Downloaded this new health tracking app today. Excited to see how it helps me stay on track with my fitness and wellness goals. The AI features look really cool!',
      mood: 4 as const,
    },
  ];
